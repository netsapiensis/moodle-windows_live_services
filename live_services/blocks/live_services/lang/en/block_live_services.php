...
//// strings in action page
//$string[ 'pagetitle' ] = 'Windows Live Services';
//$string[ 'navtext' ] = 'Windows Live Services';
...
$string[ 'use_outlook_live' ] = "User Outlook Live";
$string[ 'service_account' ] = "Service Account";
$string[ 'password' ] = "Password";
$string[ 'outlook_url' ] = "Outlook URL";
$string[ 'show_email' ] = "Show Email";
$string[ 'show_calendar' ] = "Show Calendar";
$string[ 'show_messenger' ] = "Show Messenger";
$string[ 'show_search' ] = "Show Search";
$string[ 'enable_bing_search' ] = "Enable Bing Search";